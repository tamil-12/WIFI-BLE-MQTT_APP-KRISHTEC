...
class _WifiListPageState extends State<WifiListPage> {
  ...
  Future<String?> _showPasswordDialog() {
    return showDialog<String>(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Enter Password', style: TextStyle(color: Colors.blue)), // Customize title color
        backgroundColor: Colors.white, // Set background color of the dialog
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)), // Set border radius
        content: Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(10),
            color: Colors.grey[200], // Set content background color
          ),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              Row(
                ...
                children: [
                  TextButton(
                    ...
                    child: const Text('Cancel', style: TextStyle(color: Colors.red)), // Customize cancel text color
                  ),
                  ElevatedButton(
                    onPressed: () => Navigator.pop(context, _passwordController.text),
